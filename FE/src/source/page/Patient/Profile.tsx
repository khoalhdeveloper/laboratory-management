   ...
   const handleUpdateAvatar = async () => {
    ...
    return (
        <div className="flex-1 p-6 bg-gradient-to-br from-sky-100 to-violet-100">
            ...
            {/* Patient Profile Title - Top Left */}
            <div className="mb-8">
            ...
            <div className="max-w-4xl mx-auto bg-gradient-to-br from-sky-100 to-violet-100 rounded-lg p-6">
                ...
                <div className="mb-8 text-center">
                    <div className="relative inline-block">
                        {avatar ? (
                            ...
                            <div className="w-32 h-32 rounded-full border-4 border-gray-300 shadow-lg bg-gray-100 flex items-center justify-center">
                        ...
                        <button
                            ...
                            className="absolute bottom-0 right-0 bg-gradient-to-r from-yellow-400 to-orange-500 text-white rounded-full p-2 cursor-pointer hover:from-yellow-500 hover:to-orange-600 transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    ...
                                    <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-300 shadow-sm hover:shadow-md transition-shadow">
                                        ...
                                        <p className="text-sm text-gray-700 font-medium">{formData.age || ''}</p>
                                    </div>
                                    ...
                                    <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-300 shadow-sm hover:shadow-md transition-shadow">
                                        ...
                                        <p className="text-sm text-gray-700 font-medium">{formData.gender ? formData.gender.charAt(0).toUpperCase() + formData.gender.slice(1) : ''}</p>
                                    </div>
                                    ...
                                    <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-300 shadow-sm hover:shadow-md transition-shadow">
                                        ...
                                        <p className="text-sm text-gray-700 font-medium">{formData.fullName || ''}</p>
                                    </div>
                                    ...
                                    <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-300 shadow-sm hover:shadow-md transition-shadow">
                                        ...
                                        <p className="text-sm text-gray-700 font-medium">{formatDateOfBirthForDisplay(formData.dateOfBirth)}</p>
                                    </div>
                                    ...
                                    <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-300 shadow-sm hover:shadow-md transition-shadow">
                                        ...
                                        <p className="text-sm text-gray-700 font-medium">{formData.identifyNumber || ''}</p>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-300 shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    <Field
                                        ...
                                        name="currentPassword"
                                            className={`w-full px-0 py-0 pr-8 border-none bg-transparent text-gray-700 focus:outline-none ${errors.currentPassword && touched.currentPassword ? 'border-red-500' : ''}`}
                                ...
                                <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-300 shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    <Field
                                        ...
                                        name="newPassword"
                                            className={`w-full px-0 py-0 pr-8 border-none bg-transparent text-gray-700 focus:outline-none ${errors.newPassword && touched.newPassword ? 'border-red-500' : ''}`}
                                ...
                                <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-300 shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    <Field
                                        ...
                                        name="confirmPassword"
                                            className={`w-full px-0 py-0 pr-8 border-none bg-transparent text-gray-700 focus:outline-none ${errors.confirmPassword && touched.confirmPassword ? 'border-red-500' : ''}`}
