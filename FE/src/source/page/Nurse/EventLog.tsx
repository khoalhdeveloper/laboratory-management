...
const EventLog: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen p-4 md:p-6 lg:p-8 transition-colors duration-300 ${
      ...
      {/* Enhanced Header */}
      <div className={`rounded-2xl shadow-xl p-4 md:p-6 lg:p-8 mb-6 md:mb-8 text-white transition-colors duration-300 ${
        isDarkMode 
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center space-x-3 md:space-x-4">
            ...
            <div>
              <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2">System Event Logs</h1>
              <p className="text-slate-200 text-sm md:text-base lg:text-lg">Monitor system activities and audit trail</p>
            </div>
          </div>
          <div className="hidden sm:block">
            <div className="text-right">
              <div className="text-xl md:text-2xl font-bold">{stats.total}</div>
              <div className="text-slate-300 text-sm md:text-base">Total Events</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {showStats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className={`rounded-xl shadow-sm border p-6 hover:shadow-md transition-all duration-300 ${
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className={`text-sm font-medium ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Success</p>
          ...
          <div className={`rounded-xl shadow-sm border p-6 hover:shadow-md transition-all duration-300 ${
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className={`text-sm font-medium ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Warnings</p>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative export-dropdown">
              ...
              {showExportDropdown && (
                <div className={`absolute top-full right-0 mt-1 border rounded-lg shadow-lg z-20 min-w-[140px] animate-in slide-in-from-top-2 duration-200 ${
                  ...
                  <button
                    ...
                    className={`block w-full text-left px-4 py-2 text-sm rounded-t-lg transition-colors duration-200 flex items-center ${
                  ...
                  <button
                    ...
                    className={`block w-full text-left px-4 py-2 text-sm rounded-b-lg transition-colors duration-200 flex items-center ${
                      isDarkMode ? 'text-gray-300 hover:bg-gray-700' : 'text-gray-700 hover:bg-gray-100'
                    }`}
                  >
                    <Download className="h-4 w-4 mr-2" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mt-6">
          <div>
            ...
            <select
              ...
              className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-300 ${
                isDarkMode 
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-300 ${
                  isDarkMode 
                    ? 'border-gray-600 bg-gray-700 text-white' 
                    : 'border-gray-300 bg-white text-gray-900'
                }`}
                ...
                <tbody className={`divide-y ${
                  ...
                  {paginatedLogs.map((log, index) => (
                    <tr key={log.id} className={`transition-colors duration-150 ${
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-900'}`}>{log.category}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-900'}`}>{log.operator}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className={`text-sm font-mono ${isDarkMode ? 'text-gray-300' : 'text-gray-900'}`}>{log.timestamp}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button 
                          ...
                          className={`inline-flex items-center px-3 py-1 border border-transparent text-sm font-medium rounded-md transition-colors duration-200 ${
                            isDarkMode 
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {paginatedLogs.map((log, index) => (
                  ...
                  >
                    {/* Header */}
                    <div className="flex items-start justify-between mb-4">                        <div className="flex items-center space-x-3">
      ...
      {showDetailModal && selectedLog && (
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4"
          ...
          <div className={`rounded-xl shadow-2xl border p-8 w-full max-w-4xl transform max-h-[90vh] overflow-y-auto ${
            isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-100'
          }`}
               style={{
            ...
            <div className={`rounded-xl p-6 space-y-6 transition-colors duration-300 ${
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className={`rounded-lg p-4 shadow-sm border hover:shadow-md transition-all duration-200 ${
                    ...
                    <div className={`text-sm font-mono break-all transition-colors duration-300 ${
                      isDarkMode ? 'text-white' : 'text-gray-800'
                    }`}>
              ...
              <div className={`rounded-lg p-4 shadow-sm border hover:shadow-md transition-all duration-200 ${
                ...
                <label className={`block text-xs font-semibold uppercase tracking-wider mb-3 transition-colors duration-300 ${
                  isDarkMode ? 'text-gray-400' : 'text-gray-500'
                }`}>Event Message</label>
                <div className={`px-4 py-3 rounded-md transition-colors duration-300 ${
                  ...
                  <p className={`text-sm break-words leading-relaxed transition-colors duration-300 ${
                    isDarkMode ? 'text-white' : 'text-gray-900'
                  }`}>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                <div className={`rounded-lg p-4 shadow-sm border hover:shadow-md transition-all duration-200 ${
                  ...
                  <div className={`border px-4 py-3 rounded-md min-h-[100px] transition-colors duration-300 ${
                    isDarkMode 
                      ? 'bg-gradient-to-br from-red-900/30 to-red-800/30 border-red-800' 
                      : 'bg-gradient-to-br from-red-50 to-red-100 border-red-200'
                  }`}>
                    <p className={`text-sm whitespace-pre-wrap break-words leading-relaxed transition-colors duration-300 ${
