...
function Instrucment() {
  ...
  return (
    <div className={`min-h-screen p-3 sm:p-4 lg:p-6 transition-colors ${
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6 lg:mb-8 text-white">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-1 sm:mb-2">Laboratory Equipment Registry</h1>
              <p className="text-blue-100 text-sm sm:text-base lg:text-lg">Monitor, manage and maintain your laboratory instruments</p>
            </div>
          </div>
      ...
      {/* Statistics Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
        <div className={`xl:col-span-2 rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 lg:p-6 hover:shadow-xl transition-all duration-300 ${
          isDarkMode 
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-2xl sm:text-3xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{stats.total}</p>
              <p className="text-xs sm:text-sm text-green-600 font-medium mt-1">
                <TrendingUp className="inline h-3 w-3 sm:h-4 sm:w-4 mr-1" />
                All systems operational
              </p>
            </div>
            <div className={`p-2 sm:p-2.5 lg:p-3 rounded-full ${isDarkMode ? 'bg-blue-900/50' : 'bg-blue-100'}`}>
              <BarChart3 className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-blue-600" />
            </div>
          </div>
        </div>

        <div className={`rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 lg:p-6 hover:shadow-xl transition-all duration-300 ${
          isDarkMode 
            ? 'bg-gray-800 border border-gray-700' 
            : 'bg-white border border-gray-100'
        }`}>
          <div className="flex items-center justify-between">
            ...
            <div className={`p-1.5 sm:p-2 rounded-full ${isDarkMode ? 'bg-green-900/50' : 'bg-green-100'}`}>
        ...
        <div className={`rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 lg:p-6 hover:shadow-xl transition-all duration-300 ${
          ...
          <div className="flex items-center justify-between">
            ...
            <div className={`p-1.5 sm:p-2 rounded-full ${isDarkMode ? 'bg-yellow-900/50' : 'bg-yellow-100'}`}>
        ...
        <div className={`rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 lg:p-6 hover:shadow-xl transition-all duration-300 ${
          ...
          <div className="flex items-center justify-between">
            ...
            <div className={`p-1.5 sm:p-2 rounded-full ${isDarkMode ? 'bg-red-900/50' : 'bg-red-100'}`}>
        ...
        <div className={`rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 lg:p-6 hover:shadow-xl transition-all duration-300 ${
          ...
          <div className="flex items-center justify-between">
            ...
            <div className={`p-1.5 sm:p-2 rounded-full ${isDarkMode ? 'bg-purple-900/50' : 'bg-purple-100'}`}>
      ...
      {/* Controls Bar */}
      <div className={`rounded-lg sm:rounded-xl shadow-lg p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6 lg:mb-8 ${
        isDarkMode 
          ? 'bg-gray-800 border border-gray-700' 
          : 'bg-white border border-gray-100'
      }`}>
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 sm:gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 lg:gap-4 flex-1">
            <div className="relative flex-1 max-w-full sm:max-w-md">
              <Search className={`absolute left-2.5 sm:left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 sm:h-5 sm:w-5 ${
              ...
              <input
                ...
                className={`pl-8 sm:pl-10 pr-3 sm:pr-4 py-2 sm:py-2.5 lg:py-3 w-full border rounded-lg text-sm sm:text-base focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors ${
                  isDarkMode 
            ...
            <select
              ...
              className={`px-3 sm:px-4 py-2 sm:py-2.5 lg:py-3 border rounded-lg text-xs sm:text-sm lg:text-base focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors ${
                isDarkMode 
          ...
          <div className="flex gap-2 sm:gap-3 flex-wrap sm:flex-nowrap">
            ...
            <div className="relative group">
              <button className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 border rounded-lg text-xs sm:text-sm transition-colors ${
                isDarkMode 
            ...
            <button 
              ...
              className="flex items-center gap-1.5 sm:gap-2 px-4 sm:px-5 lg:px-6 py-1.5 sm:py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg hover:shadow-xl font-medium text-xs sm:text-sm"
            >
        ...
        <div className={`mt-3 sm:mt-4 pt-3 sm:pt-4 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
          <p className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            {searchTerm && (
              <span className="block sm:inline mt-1 sm:mt-0"> matching "<span className="font-semibold text-blue-600">{searchTerm}</span>"</span>
            )}
          </p>
        </div>
      </div>
      ...
      {viewMode === 'grid' ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
          {filteredEquipments.map((equipment) => (
            <div key={equipment.id} className={`rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 lg:p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 ${
              isDarkMode 
                ? 'bg-gray-800 border border-gray-700' 
                : 'bg-white border border-gray-100'
            }`}>
              <div className="flex items-start justify-between mb-3 sm:mb-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5 sm:gap-2 mb-2 flex-wrap">
                    <div className={`p-1 rounded-full flex-shrink-0 ${
                      ...
                      {equipment.status === 'Available' ? (
                        ...
                        <Activity className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-yellow-600" />
                      ) : (
                  ...
                  <h3 className={`text-base sm:text-lg font-bold mb-1 truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{equipment.name}</h3>
                  <p className={`text-xs sm:text-sm mb-2 truncate ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>{equipment.type}</p>
                  <div className={`flex items-center text-xs sm:text-sm mb-1 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                    <MapPin className="h-3.5 w-3.5 sm:h-4 sm:w-4 mr-1 flex-shrink-0" />
                    <span className="truncate">{equipment.room}</span>
                  </div>
                  <div className={`text-xs font-mono px-2 py-1 rounded truncate ${
                    isDarkMode 
              ...
              <div className="space-y-2 sm:space-y-3 mb-3 sm:mb-4">
                <div className={`rounded-lg p-2.5 sm:p-3 ${isDarkMode ? 'bg-gray-700' : 'bg-gray-50'}`}>
                  <div className="grid grid-cols-2 gap-2 sm:gap-3 text-sm">
                    <div>
                      <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Manufacturer</p>
                      <p className={`font-medium text-xs sm:text-sm truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{equipment.manufacturer}</p>
                    </div>
                    <div>
                      <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Model</p>
                      <p className={`font-medium text-xs sm:text-sm truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{equipment.model}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between text-xs sm:text-sm">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className={`font-medium text-xs sm:text-sm truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{equipment.lastCheck}</p>
                  </div>
                  <div className="text-right flex-1 min-w-0">
                    <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Next Check</p>
                    <p className={`font-medium text-xs sm:text-sm truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{equipment.nextCheck}</p>
                  </div>
                </div>
              </div>

              <div className={`flex flex-wrap gap-1.5 sm:gap-2 pt-2.5 sm:pt-3 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-100'}`}>
                <button 
                  onClick={() => handleViewEquipment(equipment)}
                  className={`flex-1 min-w-[60px] sm:min-w-0 flex items-center justify-center gap-0.5 sm:gap-1 px-2 sm:px-3 py-1.5 sm:py-2 text-blue-600 rounded-lg transition-colors text-xs sm:text-sm font-medium ${
                ...
                <button 
                  ...
                  className={`flex-1 min-w-[60px] sm:min-w-0 flex items-center justify-center gap-0.5 sm:gap-1 px-2 sm:px-3 py-1.5 sm:py-2 text-green-600 rounded-lg transition-colors text-xs sm:text-sm font-medium ${
                ...
                <button 
                  ...
                  className={`flex items-center justify-center px-2 sm:px-3 py-1.5 sm:py-2 text-orange-600 rounded-lg transition-colors text-xs sm:text-sm font-medium ${
                ...
                <button 
                  ...
                  className={`flex items-center justify-center px-2 sm:px-3 py-1.5 sm:py-2 text-red-600 rounded-lg transition-colors text-xs sm:text-sm font-medium ${
        ...
        /* Table View */
        <div className={`rounded-lg sm:rounded-xl shadow-lg mb-4 sm:mb-6 lg:mb-8 ${
          isDarkMode 
            ? 'bg-gray-800 border border-gray-700' 
            : 'bg-white border border-gray-100'
        }`}>
          <div className={`p-3 sm:p-4 lg:p-6 border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
            <h3 className={`text-base sm:text-lg font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Equipment Details</h3>
          </div>
          <div className="overflow-x-auto">
            <table className={`min-w-full divide-y ${isDarkMode ? 'divide-gray-700' : 'divide-gray-200'}`}>
              <thead className={isDarkMode ? 'bg-gray-700' : 'bg-gray-50'}>
                <tr>
                  <th className={`px-3 sm:px-4 lg:px-6 py-3 sm:py-4 text-left text-xs font-medium uppercase tracking-wider ${
              ...
              <tbody className={`divide-y ${
                ...
                {filteredEquipments.map((equipment) => (
                  <tr key={equipment.id} className={`transition-colors ${
                    ...
                    <td className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
                      <div className="flex items-center">
                        ...
                        <div className="min-w-0">
                          <div className={`text-xs sm:text-sm font-bold truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{equipment.name}</div>
                          <div className={`text-xs sm:text-sm truncate ${isDarkMode ? 'text-gray-300' : 'text-gray-500'}`}>{equipment.type}</div>
                          <div className={`text-xs font-mono truncate ${isDarkMode ? 'text-gray-400' : 'text-gray-400'}`}>{equipment.id}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
                      <div className={`text-xs sm:text-sm ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                        <div className="font-medium truncate">{equipment.manufacturer}</div>
                        <div className={`truncate ${isDarkMode ? 'text-gray-300' : 'text-gray-500'}`}>{equipment.model}</div>
                        <div className={`text-xs truncate ${isDarkMode ? 'text-gray-400' : 'text-gray-400'}`}>{equipment.serialNumber}</div>
                      </div>
                    </td>
                    <td className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
                      <div className={`flex items-center text-xs sm:text-sm ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                        <MapPin className={`h-3.5 w-3.5 sm:h-4 sm:w-4 mr-1 flex-shrink-0 ${isDarkMode ? 'text-gray-400' : 'text-gray-400'}`} />
                        <span className="truncate">{equipment.room}</span>
                      </div>
                    </td>
                    <td className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
                    ...
                    <td className={`px-3 sm:px-4 lg:px-6 py-3 sm:py-4 text-xs sm:text-sm ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                      <div className="space-y-1">
                        <div className={`flex items-center ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                          ...
                          <span className="text-xs truncate">Last: {equipment.lastCheck}</span>
                        </div>
                        <div className={`flex items-center ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                          <Clock className="h-3.5 w-3.5 sm:h-4 sm:w-4 mr-1 flex-shrink-0" />
                          <span className="text-xs truncate">Next: {equipment.nextCheck}</span>
                        </div>
                      </div>
                    </td>
                    <td className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
                      <div className="flex flex-wrap gap-1 sm:gap-2">
                        ...
                        <button 
                          onClick={() => handleCheckEquipment(equipment)}
                          className={`p-1.5 sm:p-2 text-orange-600 rounded-lg transition-colors ${
                            isDarkMode 
                        ...
                        <button 
                          onClick={() => handleDeleteEquipment(equipment)}
                          className={`p-1.5 sm:p-2 text-red-600 rounded-lg transition-colors ${
                            isDarkMode 
      ...
      {filteredEquipments.length === 0 && (
        <div className={`rounded-lg sm:rounded-xl shadow-lg p-6 sm:p-8 lg:p-12 text-center ${
          isDarkMode 
            ? 'bg-gray-800 border border-gray-700' 
            : 'bg-white border border-gray-100'
        }`}>
          <div className="max-w-md mx-auto">
            <div className={`p-3 sm:p-4 rounded-full w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 flex items-center justify-center ${
              isDarkMode ? 'bg-gray-700' : 'bg-gray-100'
            }`}>
              <Settings className={`h-6 w-6 sm:h-8 sm:w-8 ${isDarkMode ? 'text-gray-400' : 'text-gray-400'}`} />
            </div>
            <h3 className={`text-base sm:text-lg font-semibold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>No equipment found</h3>
            ...
            {(!searchTerm && statusFilter === 'All' && roomFilter === 'All' && typeFilter === 'All') && (
              <button 
                onClick={() => setIsAddModalOpen(true)}
                className="inline-flex items-center gap-1.5 sm:gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium text-xs sm:text-sm lg:text-base"
              >
                <Plus className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                Add First Equipment
              </button>
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 p-3 sm:p-4"
          ...
          <div className={`rounded-lg sm:rounded-xl p-4 sm:p-6 lg:p-8 w-full max-w-2xl shadow-2xl transform transition-all max-h-[90vh] overflow-y-auto ${
            isDarkMode 
              ? 'bg-gray-800 border border-gray-700' 
              : 'bg-white border border-gray-100'
          }`}
            ...
            <div className={`flex items-center justify-between mb-4 sm:mb-6 pb-3 sm:pb-4 border-b ${
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className={`text-xs sm:text-sm mt-0.5 sm:mt-1 ${isDarkMode ? 'text-gray-300' : 'text-gray-500'}`}>Fill in the equipment details below</p>
                </div>
              </div>
              <button 
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                <div>
                  <label className={`block text-xs sm:text-sm font-semibold mb-1.5 sm:mb-2 flex items-center ${
                    isDarkMode ? 'text-gray-200' : 'text-gray-700'
                  }`}>
                    <svg className={`w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <input
                    ...
                    className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 lg:py-3 border rounded-lg text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
                      isDarkMode 
                        ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-400 hover:bg-gray-600' 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewEquipment({...newEquipment, lastCheck: e.target.value})}
                    className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 lg:py-3 border rounded-lg text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
                      isDarkMode 
                        ? 'bg-gray-700 border-gray-600 text-white hover:bg-gray-600' 
                        : 'bg-gray-50 border-gray-200 text-gray-900 hover:bg-white'
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewEquipment({...newEquipment, nextCheck: e.target.value})}
                    className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 lg:py-3 border rounded-lg text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
                      isDarkMode 
                        ? 'bg-gray-700 border-gray-600 text-white hover:bg-gray-600' 
                        : 'bg-gray-50 border-gray-200 text-gray-900 hover:bg-white'
            ...
            <div className={`flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 lg:gap-4 pt-4 sm:pt-6 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-100'}`}>
              <button 
                onClick={handleAddEquipment}
                className="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-4 sm:px-6 py-2 sm:py-2.5 lg:py-3 rounded-lg text-xs sm:text-sm font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center"
              >
              ...
              <button 
                onClick={() => setIsAddModalOpen(false)}
                className={`flex-1 border-2 px-4 sm:px-6 py-2 sm:py-2.5 lg:py-3 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-200 ${
                  isDarkMode 
      ...
      {isViewModalOpen && selectedEquipment && (
        <div className="fixed inset-0 flex items-center justify-center z-50 backdrop-blur-sm p-3 sm:p-4">
          <div className={`rounded-lg sm:rounded-xl p-4 sm:p-6 lg:p-8 w-full max-w-lg shadow-2xl transform transition-all max-h-[90vh] overflow-y-auto ${
            isDarkMode 
              ? 'bg-gray-800 border border-gray-700' 
              : 'bg-white border border-gray-100'
          }`}>
            ...
            <div className={`rounded-lg sm:rounded-xl p-4 sm:p-5 lg:p-6 space-y-3 sm:space-y-4 lg:space-y-5 ${
              isDarkMode 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                <div className="space-y-3 sm:space-y-4">
                  <div className={`rounded-lg p-3 sm:p-4 shadow-sm ${
                    ...
                    <label className={`block text-xs font-semibold uppercase tracking-wider mb-1.5 sm:mb-2 ${
                      isDarkMode ? 'text-gray-300' : 'text-gray-500'
                    }`}>Equipment ID</label>
                    <p className={`text-sm sm:text-base lg:text-lg font-mono font-bold break-all ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{selectedEquipment.id}</p>
                  </div>
                  ...
                  <div className={`rounded-lg p-3 sm:p-4 shadow-sm ${
                    ...
                    <p className={`text-sm sm:text-base lg:text-lg font-semibold truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{selectedEquipment.name}</p>
                  </div>
                  ...
                  <div className={`rounded-lg p-3 sm:p-4 shadow-sm ${
                    ...
                    <p className={`text-sm sm:text-base lg:text-lg font-medium truncate ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>{selectedEquipment.type}</p>
                  </div>
                </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className={`rounded-lg p-3 sm:p-4 shadow-sm ${
                    ...
                    <p className={`text-sm sm:text-base lg:text-lg font-medium truncate ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>{selectedEquipment.room}</p>
                  </div>
                  ...
                  <div className={`rounded-lg p-3 sm:p-4 shadow-sm ${
                    ...
                    <div className="grid grid-cols-2 gap-3 sm:gap-4">
                      <div>
                        ...
                        <p className={`text-xs sm:text-sm font-medium truncate ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>{selectedEquipment.lastCheck}</p>
                      </div>
                      <div>
                        <label className={`block text-xs font-semibold uppercase tracking-wider mb-1 ${
                          isDarkMode ? 'text-gray-300' : 'text-gray-500'
                        }`}>Next Check</label>
                        <p className={`text-xs sm:text-sm font-medium truncate ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>{selectedEquipment.nextCheck}</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className={`flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 lg:gap-4 pt-4 sm:pt-6 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
              <button 
                onClick={() => {
          ...
          <div className={`rounded-lg sm:rounded-xl p-4 sm:p-6 lg:p-8 w-full max-w-lg shadow-2xl transform transition-all max-h-[90vh] overflow-y-auto ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 lg:py-3 border rounded-lg text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all ${
                      isDarkMode 
                        ? 'bg-gray-700 border-gray-600 text-white placeholder-gray-400 hover:bg-gray-600' 
                        : 'bg-gray-50 border-gray-200 text-gray-900 hover:bg-white'
                    }`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditEquipment({...editEquipment, lastCheck: e.target.value})}
                    className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 lg:py-3 border rounded-lg text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all ${
                      isDarkMode 
                        ? 'bg-gray-700 border-gray-600 text-white hover:bg-gray-600' 
                        : 'bg-gray-50 border-gray-200 text-gray-900 hover:bg-white'
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditEquipment({...editEquipment, nextCheck: e.target.value})}
                    className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 lg:py-3 border rounded-lg text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all ${
                      isDarkMode 
                        ? 'bg-gray-700 border-gray-600 text-white hover:bg-gray-600' 
                        : 'bg-gray-50 border-gray-200 text-gray-900 hover:bg-white'
            ...
            <div className={`flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 lg:gap-4 pt-4 sm:pt-6 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-100'}`}>
              <button 
                ...
                className="flex-1 bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white px-4 sm:px-6 py-2 sm:py-2.5 lg:py-3 rounded-lg text-xs sm:text-sm font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center"
              >
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 backdrop-blur-sm p-3 sm:p-4">
          <div className={`rounded-lg sm:rounded-xl p-4 sm:p-6 lg:p-8 w-full max-w-lg shadow-2xl transform transition-all max-h-[90vh] overflow-y-auto ${
            ...
            <div className="mb-4 sm:mb-6">
              <div className={`border-l-4 border-red-400 p-4 sm:p-5 lg:p-6 rounded-lg mb-4 sm:mb-6 ${
                isDarkMode 
              ...
              <div className={`border-2 rounded-lg p-3 sm:p-4 ${
                ...
                <h5 className={`text-xs sm:text-sm font-semibold mb-2 sm:mb-3 uppercase tracking-wider ${
                  isDarkMode ? 'text-gray-200' : 'text-gray-700'
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className={`flex justify-between items-center py-1.5 sm:py-2 border-b ${
                    ...
                    <span className={`text-xs sm:text-sm font-mono font-bold truncate ml-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{selectedEquipment.id}</span>
                  </div>
                  <div className="flex justify-between items-center py-1.5 sm:py-2">
                    <span className={`text-xs sm:text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Room:</span>
                    <span className={`text-xs sm:text-sm font-semibold truncate ml-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{selectedEquipment.room}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={`flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 lg:gap-4 pt-4 sm:pt-6 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
              <button 
                ...
                className="flex-1 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-4 sm:px-6 py-2 sm:py-2.5 lg:py-3 rounded-lg text-xs sm:text-sm font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center"
              >
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                </svg>
