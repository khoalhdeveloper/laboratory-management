...
const ReagentHistory: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900 rounded-xl shadow-sm p-6 border border-blue-100 dark:border-blue-800">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white dark:text-white flex items-center gap-3">
              <div className="p-2 bg-blue-600 rounded-lg">
                <Beaker className="h-8 w-8 text-white" />
              </div>
              Reagent Management System
            </h1>
            <p className="text-gray-600 dark:text-gray-400 dark:text-gray-300 mt-2 text-lg">Track reagent supply, usage history, and vendor management for compliance and audit purposes</p>
          </div>
          <div className="flex gap-3">
            <button 
              onClick={() => setShowStats(!showStats)}
              className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border border-gray-200 dark:border-gray-600"
            >
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10 min-w-[120px]">
                <button 
          ...
          {activeTab === 'supply' ? (
            <>
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-l-4 border-blue-500">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400 dark:text-gray-400">Total Supplies</p>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white dark:text-white">{supplyStats.total}</p>
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-l-4 border-green-500">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400 dark:text-gray-400">Received</p>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white dark:text-white">{supplyStats.received}</p>
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-l-4 border-yellow-500">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Partial Shipments</p>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{supplyStats.partial}</p>
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-l-4 border-red-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{supplyStats.returned}</p>
                  </div>
            ...
            <>
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-l-4 border-purple-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{usageStats.total}</p>
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-l-4 border-green-500">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Active Usage</p>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{usageStats.used}</p>
                  </div>
                  <div className="p-3 bg-green-100 rounded-full">
                    <CheckCircle className="h-6 w-6 text-green-600" />
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-l-4 border-blue-500">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Consumed</p>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{usageStats.consumed}</p>
                  </div>
                  <div className="p-3 bg-blue-100 rounded-full">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-l-4 border-red-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{usageStats.expired}</p>
                  </div>
                  <div className="p-3 bg-red-100 rounded-full">
                    <XCircle className="h-6 w-6 text-red-600" />
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-l-4 border-blue-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{vendorStats.active}</p>
                  </div>
                  <div className="p-3 bg-blue-100 rounded-full">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-l-4 border-purple-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{vendorStats.newThisMonth}</p>
                  </div>
                  <div className="p-3 bg-purple-100 rounded-full">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-l-4 border-orange-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{vendorStats.countries}</p>
                  </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
          ...
          <nav className="flex space-x-8 px-6">
            <button
              ...
              className={`py-4 px-2 border-b-2 font-medium text-sm transition-all duration-200 ${
                activeTab === 'supply'
                  ? 'border-blue-500 text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900 rounded-t-lg'
                  : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-t-lg'
              }`}
            >
              <div className="flex items-center gap-3 px-3 py-1">
                <div className={`p-1 rounded-full ${activeTab === 'supply' ? 'bg-blue-200 dark:bg-blue-800' : 'bg-gray-200 dark:bg-gray-600'}`}>
                  <Truck className="h-4 w-4" />
                </div>
                <span className="font-semibold">Supply History</span>
                <span className={`px-2 py-1 text-xs rounded-full ${activeTab === 'supply' ? 'bg-blue-200 dark:bg-blue-800 text-blue-800 dark:text-blue-200' : 'bg-gray-200 dark:bg-gray-600 text-gray-600 dark:text-gray-400'}`}>
                  {supplyStats.total}
                </span>
              </div>
            </button>
            <button
              ...
              className={`py-4 px-2 border-b-2 font-medium text-sm transition-all duration-200 ${
                activeTab === 'usage'
                  ? 'border-purple-500 text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-900 rounded-t-lg'
                  : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-t-lg'
              }`}
            >
              <div className="flex items-center gap-3 px-3 py-1">
                <div className={`p-1 rounded-full ${activeTab === 'usage' ? 'bg-purple-200 dark:bg-purple-800' : 'bg-gray-200 dark:bg-gray-600'}`}>
                  <Package className="h-4 w-4" />
                </div>
                <span className="font-semibold">Usage History</span>
                <span className={`px-2 py-1 text-xs rounded-full ${activeTab === 'usage' ? 'bg-purple-200 dark:bg-purple-800 text-purple-800 dark:text-purple-200' : 'bg-gray-200 dark:bg-gray-600 text-gray-600 dark:text-gray-400'}`}>
                  {usageStats.total}
                </span>
              </div>
            </button>
            <button
              ...
              className={`py-4 px-2 border-b-2 font-medium text-sm transition-all duration-200 ${
                activeTab === 'vendors'
                  ? 'border-green-500 text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900 rounded-t-lg'
                  : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-t-lg'
              }`}
            >
              <div className="flex items-center gap-3 px-3 py-1">
                <div className={`p-1 rounded-full ${activeTab === 'vendors' ? 'bg-green-200 dark:bg-green-800' : 'bg-gray-200 dark:bg-gray-600'}`}>
                  <Building2 className="h-4 w-4" />
                </div>
                <span className="font-semibold">Vendors</span>
                <span className={`px-2 py-1 text-xs rounded-full ${activeTab === 'vendors' ? 'bg-green-200 dark:bg-green-800 text-green-800 dark:text-green-200' : 'bg-gray-200 dark:bg-gray-600 text-gray-600 dark:text-gray-400'}`}>
                  {vendorStats.total}
                </span>
              </div>
            </button>
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-3 w-full border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm"
                />
              </div>
              {activeTab !== 'vendors' && (
                <div className="relative">
              ...
              {activeTab === 'supply' && (
                <div className="relative">
                  ...
                  <select
                    ...
                    className="pl-10 pr-4 py-3 w-full border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm"
                  >
            ...
            <div className="flex gap-3">
              <button className="flex items-center gap-2 px-4 py-3 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border border-gray-300 dark:border-gray-600 shadow-sm">
              ...
              {(searchTerm || dateFilter || vendorFilter) && (
                <button 
                  ...
                  className="flex items-center gap-2 px-4 py-3 bg-red-50 dark:bg-red-900 text-red-700 dark:text-red-300 rounded-lg hover:bg-red-100 dark:hover:bg-red-800 transition-colors border border-red-200 dark:border-red-700 shadow-sm"
                >
                  <X className="h-4 w-4" />
                  Clear Filters
                </button>
        ...
        {/* Results Summary */}
        {(searchTerm || dateFilter || vendorFilter) && (
          <div className="px-6 py-3 bg-blue-50 dark:bg-blue-900 border-b border-blue-100 dark:border-blue-800">
        ...
        <div className="p-6 bg-white dark:bg-gray-800">
          {activeTab === 'supply' ? (
            ...
            <div className="overflow-hidden shadow-sm border border-gray-200 dark:border-gray-700 rounded-xl">
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {filteredSupplyHistory.length === 0 ? (
                      <tr>
                        <td colSpan={6} className="px-6 py-12 text-center">
                          <div className="text-gray-500">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No supply records found</h3>
                      ...
                      <tr key={supply.id} className="hover:bg-blue-50 dark:hover:bg-blue-900 transition-colors">
                        <td className="px-6 py-5">
                          <div className="space-y-1">
                            <div className="text-sm font-semibold text-gray-900 dark:text-white">{supply.reagentName}</div>
                        ...
                        <td className="px-6 py-5">
                          <div className="space-y-1">
                            <div className="text-sm font-medium text-gray-900 dark:text-white">PO: {supply.poNumber}</div>
                        ...
                        <td className="px-6 py-5">
                          <div className="space-y-1">
                            <div className="text-sm font-medium text-gray-900 dark:text-white">Lot: {supply.lotNumber}</div>
            ...
            <div className="overflow-hidden shadow-sm border border-gray-200 dark:border-gray-700 rounded-xl">
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  <thead className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900 dark:to-purple-800">
                    <tr>
                      <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                        <div className="flex items-center gap-2">
                          <Beaker className="h-4 w-4" />
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {filteredUsageHistory.length === 0 ? (
                      <tr>
                        <td colSpan={6} className="px-6 py-12 text-center">
                          <div className="text-gray-500">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No usage records found</h3>
                            <p className="text-sm">Try adjusting your search or filter criteria</p>
                          </div>
                        </td>
                      </tr>
                      ...
                      <tr key={usage.id} className="hover:bg-purple-50 dark:hover:bg-purple-900 transition-colors">
                        <td className="px-6 py-5">
                          <div className="space-y-1">
                            <div className="text-sm font-semibold text-gray-900 dark:text-white">{usage.reagentName}</div>
                        ...
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="text-sm font-medium text-gray-900 dark:text-white">{usage.usedBy}</div>
                        ...
                        <td className="px-6 py-5">
                          <div className="space-y-2">
                            <div className="text-sm text-gray-900 dark:text-white p-2 bg-blue-50 rounded border-l-4 border-blue-400">
                              {usage.purpose}
                            </div>
                            {usage.testId && (
            ...
            <div className="overflow-hidden shadow-sm border border-gray-200 dark:border-gray-700 rounded-xl">
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  <thead className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900 dark:to-green-800">
                    <tr>
                      <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                        <div className="flex items-center gap-2">
                          <Building2 className="h-4 w-4" />
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {filteredVendorList.length === 0 ? (
                      ...
                      <tr key={vendor._id} className="hover:bg-green-50 dark:hover:bg-green-900 transition-colors">
                        <td className="px-6 py-5">
                          <div className="space-y-1">
                        ...
                        <td className="px-6 py-5">
                          <div className="space-y-2">
                            ...
                            <div className="text-xs text-gray-600 dark:text-gray-400 bg-gray-50 px-2 py-1 rounded flex items-start gap-1">
                              <span>📍</span>
        ...
        {showModal && (
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 w-full max-w-4xl transform max-h-[90vh] overflow-y-auto"
                 style={{
              ...
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200 dark:border-gray-600">
                ...
                <button
                  ...
                  className="text-gray-400 hover:text-gray-600 dark:text-gray-400 hover:bg-gray-100 p-2 rounded-full transition-colors duration-200 hover:shadow-md"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="rounded-xl p-6 space-y-6"
                ...
                {modalType === 'delete' ? (
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Delete Record</h3>
                  ...
                  <div className="space-y-6">
                    <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200"
                      ...
                      <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Record Details</h4>
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        {selectedItem && Object.entries(selectedItem).map(([key, value]) => (
                          <div key={key} className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 rounded-lg border border-gray-200">
                            ...
                            <div className="text-sm font-medium text-gray-900 dark:text-white">{value?.toString() || 'N/A'}</div>
                          </div>
                        ))}
                      </div>
                    </div>
              ...
              <div className="flex space-x-4 pt-6 mt-6 border-t border-gray-200"
                ...
                {modalType === 'delete' ? (
                  <>
                    <button
                      onClick={() => setShowModal(false)}
                      className="flex-1 border-2 border-gray-200 hover:border-gray-300 text-gray-700 hover:text-gray-900 dark:text-white px-6 py-3 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-all duration-200 hover:shadow-md"
                    >
                      Cancel
                    </button>
                    <button
