...
const Profile: React.FC = () => {
            ...
            fileInput.onchange = async (e) => {
                ...
                if (file) {
                    try {
                        ...
                        setUserData(prev => prev ? { ...prev, avatar: uploadedUrl, image: uploadedUrl } : null);
    ...
    const handlePasswordSubmit = async (values: any) => {
        if (!userData || (!userData._id && !userData.userid)) {
            showNotification('User information not found. Please reload the page.', 'error');
            return;
        }
        ...
        try {
            ...
            const userIdToUse = userData.userid || userData._id;
            if (!userIdToUse) {
                showNotification('User ID not found. Please reload the page.', 'error');
                return;
            }
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    ...
                                    <div className={`p-3 sm:p-4 rounded-lg border shadow-sm transition-colors duration-300 ${isDarkMode ? 'bg-gray-700 border-gray-600' : 'bg-gradient-to-r from-blue-50 to-purple-50 border-blue-300'}`}>
                                        <div className="flex items-center gap-2 sm:gap-3">
                                            ...
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <p className={`text-xs sm:text-sm lg:text-base truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{userData.email || 'N/A'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className={`p-3 sm:p-4 rounded-lg border shadow-sm transition-colors duration-300 ${isDarkMode ? 'bg-gray-700 border-gray-600' : 'bg-gradient-to-r from-blue-50 to-purple-50 border-blue-300'}`}>
                                        <div className="flex items-center gap-2 sm:gap-3">
                                            ...
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <p className={`text-xs sm:text-sm lg:text-base truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{userData.phoneNumber || 'N/A'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className={`p-3 sm:p-4 rounded-lg border shadow-sm transition-colors duration-300 ${isDarkMode ? 'bg-gray-700 border-gray-600' : 'bg-gradient-to-r from-blue-50 to-purple-50 border-blue-300'}`}>
                                        <div className="flex items-center gap-2 sm:gap-3">
                                            ...
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <p className={`text-xs sm:text-sm lg:text-base ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{userData.age || 'N/A'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className={`p-3 sm:p-4 rounded-lg border shadow-sm transition-colors duration-300 ${isDarkMode ? 'bg-gray-700 border-gray-600' : 'bg-gradient-to-r from-blue-50 to-purple-50 border-blue-300'}`}>
                                        <div className="flex items-center gap-2 sm:gap-3">
                                            ...
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <p className={`text-xs sm:text-sm lg:text-base truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{userData.fullName || 'N/A'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className={`p-3 sm:p-4 rounded-lg border shadow-sm transition-colors duration-300 ${isDarkMode ? 'bg-gray-700 border-gray-600' : 'bg-gradient-to-r from-blue-50 to-purple-50 border-blue-300'}`}>
                                        <div className="flex items-center gap-2 sm:gap-3">
                                            ...
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <p className={`text-xs sm:text-sm lg:text-base truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{userData.address || 'N/A'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className={`p-3 sm:p-4 rounded-lg border shadow-sm transition-colors duration-300 ${isDarkMode ? 'bg-gray-700 border-gray-600' : 'bg-gradient-to-r from-blue-50 to-purple-50 border-blue-300'}`}>
                                        <div className="flex items-center gap-2 sm:gap-3">
                                            ...
                                            <div className="min-w-0 flex-1">
                                                <p className={`text-[10px] sm:text-xs font-medium ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`}>CCCD</p>
                                                <p className={`text-xs sm:text-sm lg:text-base truncate ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{userData.identifyNumber || 'N/A'}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
